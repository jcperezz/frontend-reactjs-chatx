    ...
    return (
        <Container id='chatroom' fluid style={{ backgroundColor: '#CDC4F9'}}>
            <Row>
                <Col>
                    <div>
                    <h1 className='m-5'> <Link to={'/'} onClick={onClickHome}><FaHome></FaHome></Link> Bienvenido al Super Chat! {user.nick}</h1>
                    </div>
                </Col>
            </Row>
            <Row>
                        ...
                        <div className='card' id='chat3' style={{ borderRadius: '15px' }}>
                            <div className='card-body'>
                                <div className='row'>
                                    ...
                                    <div className='box-1 mt-md-0 mt-5 rounded' style={{ overflowY: 'scroll', maxHeight: '200px' }}>
                                    ...
                                    <div className='box-2 d-flex flex-column h-100 bg-secondary rounded'>
