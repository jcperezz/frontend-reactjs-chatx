...
const Chatroom: React.FC = () => {
    ...
    // funciones
    const scrollToBottom = () => endOfContentRef.current?.scrollIntoView({ behavior: 'smooth' });
    ...
    const onSendMessage = (outMessage: Message) => ChatService.sendMessage(outMessage);
    ...
    }, [userSelected, allMessages, onlineUsers, user]); // El array de dependencias vacío asegura que este efecto se ejecute solo una vez.
    ...
    return (
        <Container id='chatroom' fluid className="vh-100">
            <Row>
                <Col>
                    <div>
                        ...
                        <div className='card' id='chat3' style={{ borderRadius: '15px' }}>
                            <div className='card-body'>
                                <div className='row'>
                                    ...
                                    <div className='col-md-6 col-lg-5 col-xl-4 mb-4 mb-md-0 rounded' style={{ position: 'relative', overflowY: 'auto', height: '400px', maxHeight: '400px' }}>

                                        <div className='p-3'>
                                            <div className='input-group rounded mb-3' style={{ backgroundColor: '#F5F5F5' }}>
